...
bedtools slop -b 1000000 -i ~/pgx-pipeline/validation/pgx-genes_GRCh37.bed -g hg19.genome > \
...
bedtools slop -b 1000000 -i ~/pgx-pipeline/validation/pgx-genes_GRCh38.bed -g hg38.genome > \
